...
const SalonProfile = () => {
  ...
  const main = () => {
    switch (index) {
      case 0:
        return <EditSalonprofile salon={salon} />;
      case 1:
        return <SalonDashboard />;
      case 5:
        return <SalonBarbers salonid={salon.id} barberIDs={barbers}/>;
      // case2: Reserves
      // case3: Comments
      // case4: Notifications
      default:
  ...
  return (
    <div className={style.container} style={{ backgroundImage: `url(${salon.profile_picture})`,backgroundSize: 'cover',
